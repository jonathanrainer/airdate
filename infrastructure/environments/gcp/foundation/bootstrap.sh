...
#
# - A project within a GCP account called Airdate Foundation
...
gcloud projects create $PROJECT_ID --name "Airdate Foundation" --set-as-default
...
gcloud storage buckets create gs://airdate-foundation-state --public-access-prevention --project $PROJECT_ID
